FactoryBot.define do
  factory :stock_product, class: Shopr::Product do
    ...
    tax_rate            { Shopr::TaxRate.find_by_rate(20) || create(:standard_tax) }
    stock_control       true
    transient do
      initial_stock nil
    end
    ...
    after(:build) do |product, _ev|
      pc = Shopr::ProductCategory.find_by_permalink('phones') || build(:phones_category)
  ...
  factory :software_product, class: Shopr::Product do
