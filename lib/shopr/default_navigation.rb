require 'shopr/navigation_manager'

# This file defines all the default navigation managers used in Shopr. Of course,
...
#
Shopr::NavigationManager.build(:admin_primary) do
  add_item :customers
  add_item :orders
  add_item :products
