module Shopr
  class TaxRate < ApplicationRecord
    ...
    has_many :products, dependent: :restrict_with_exception, class_name: 'Shopr::Product'

    # All delivery service prices which are assigned to this tax rate
    has_many :delivery_service_prices, dependent: :restrict_with_exception, class_name: 'Shopr::DeliveryServicePrice'
