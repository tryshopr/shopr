module Shopr
  class Order < ActiveRecord::Base
    ...
    #
    # @return [Shopr::User]
    belongs_to :accepter, class_name: 'Shopr::User', foreign_key: 'accepted_by'

    # The Shopr::User who rejected the order
    #
    # @return [Shopr::User]
    belongs_to :rejecter, class_name: 'Shopr::User', foreign_key: 'rejected_by'
