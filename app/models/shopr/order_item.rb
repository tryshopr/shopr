module Shopr
  class OrderItem < ActiveRecord::Base
    ...
    #
    # @return [Shopr::Order]
    belongs_to :order, class_name: 'Shopr::Order', touch: true, inverse_of: :order_items
    ...
    has_many :stock_level_adjustments, as: :parent, dependent: :nullify, class_name: 'Shopr::StockLevelAdjustment'
    ...
    # exist already.
    #
    # @param ordered_item [Object] an object which implements the Shopr::OrderableItem protocol
    ...
    def increase!(amount = 1)
      transaction do
        ...
        unless in_stock?
          fail Shopr::Errors::NotEnoughStock, ordered_item: ordered_item, requested_stock: self.quantity
        end
        save!
        order.remove_delivery_service_if_invalid
      end
