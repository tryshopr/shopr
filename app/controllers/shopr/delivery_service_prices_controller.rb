  ...
  class DeliveryServicePricesController < Shopr::ApplicationController
    ...
    def create
      ...
      if @delivery_service_price.save
        redirect_to [@delivery_service, :delivery_service_prices], notice: t('shopr.delivery_service_prices.create_notice')
      else
        render action: 'new'
      end
    end
    ...
    def update
      if @delivery_service_price.update(safe_params)
        redirect_to [@delivery_service, :delivery_service_prices], notice: t('shopr.delivery_service_prices.update_notice')
      else
        render action: 'edit'
      end
    end
    ...
    def destroy
      ...
      redirect_to [@delivery_service, :delivery_service_prices], notice: t('shopr.delivery_service_prices.destroy_notice')
    end
